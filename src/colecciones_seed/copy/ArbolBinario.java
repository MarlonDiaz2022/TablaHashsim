...
public class ArbolBinario<T>
{
   ...
   /**
    ...
    /**
     * Metodo que retorna el codigo  Å?ukasiewicz del arbol binario; Este codigo etiqueta los nodos internos con "a" 
     * y los externos con una "b" y realiza el recorrido en preorden con estas convenciones. <br>
     * <b>post: </b> Se retorno el codigo  Å?ukasiewicz del Arbol Binario.<br>
     * @return  un String con el codigo  Å?ukasiewicz del arbol binario
     */ 
    public String Luca()
    {
